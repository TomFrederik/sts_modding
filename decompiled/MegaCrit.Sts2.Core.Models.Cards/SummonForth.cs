...
public sealed class SummonForth : CardModel
{
	...
	protected override IEnumerable<IHoverTip> ExtraHoverTips => HoverTipFactory.FromForge().Concat(new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromKeyword(CardKeyword.Retain)));
