...
public sealed class FanOfKnives : CardModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new _003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new CardsVar("Shivs", 4));
	...
	{
		NCombatRoom.Instance?.BackCombatVfxContainer.AddChildSafely((Node?)(object)NFanOfKnivesVfx.Create(base.Owner.Creature));
