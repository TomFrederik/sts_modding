...
public sealed class DramaticEntrance : CardModel
{
	...
	protected override IEnumerable<string> ExtraRunAssetPaths => new _003C_003Ez__ReadOnlySingleElementList<string>(SceneHelper.GetScenePath("vfx/vfx_dramatic_entrance_fullscreen"));
