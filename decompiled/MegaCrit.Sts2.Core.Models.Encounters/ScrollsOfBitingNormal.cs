...
public sealed class ScrollsOfBitingNormal : EncounterModel
{
	...
	public override IEnumerable<EncounterTag> Tags => new _003C_003Ez__ReadOnlySingleElementList<EncounterTag>(EncounterTag.Scrolls);

	public override IEnumerable<MonsterModel> AllPossibleMonsters => new _003C_003Ez__ReadOnlySingleElementList<MonsterModel>(ModelDb.Monster<ScrollOfBiting>());
