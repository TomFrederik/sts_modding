...
public sealed class KnightsElite : EncounterModel
{
	...
	public override IEnumerable<EncounterTag> Tags => new _003C_003Ez__ReadOnlySingleElementList<EncounterTag>(EncounterTag.Knights);

	public override bool HasScene => true;

	public override IEnumerable<string>? ExtraAssetPaths => new _003C_003Ez__ReadOnlySingleElementList<string>(ModelDb.Affliction<Hexed>().OverlayPath);
