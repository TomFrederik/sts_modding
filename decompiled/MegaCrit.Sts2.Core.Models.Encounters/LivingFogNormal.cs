...
public sealed class LivingFogNormal : EncounterModel
{
	...
	public override IEnumerable<string>? ExtraAssetPaths => new _003C_003Ez__ReadOnlySingleElementList<string>(ModelDb.Affliction<Smog>().OverlayPath);
	...
	{
		return new _003C_003Ez__ReadOnlySingleElementList<(MonsterModel, string)>((ModelDb.Monster<LivingFog>().ToMutable(), "livingFog"));
	}
}
