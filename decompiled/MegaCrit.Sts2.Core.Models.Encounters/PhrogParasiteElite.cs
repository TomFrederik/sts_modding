...
public sealed class PhrogParasiteElite : EncounterModel
{
	...
	public override IEnumerable<string> ExtraAssetPaths => new _003C_003Ez__ReadOnlySingleElementList<string>(ModelDb.Card<Infection>().OverlayPath);
	...
	{
		return new _003C_003Ez__ReadOnlySingleElementList<(MonsterModel, string)>((ModelDb.Monster<PhrogParasite>().ToMutable(), "phrog"));
	}
}
