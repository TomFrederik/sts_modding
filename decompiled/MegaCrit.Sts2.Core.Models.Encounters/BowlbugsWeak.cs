...
public sealed class BowlbugsWeak : EncounterModel
{
	...
	public override IEnumerable<EncounterTag> Tags => new _003C_003Ez__ReadOnlySingleElementList<EncounterTag>(EncounterTag.Workers);
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters => Bugs.Concat(new _003C_003Ez__ReadOnlySingleElementList<MonsterModel>(ModelDb.Monster<BowlbugRock>()));
