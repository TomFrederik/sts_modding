...
public sealed class PhantasmalGardenersElite : EncounterModel
{
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters => new _003C_003Ez__ReadOnlySingleElementList<MonsterModel>(ModelDb.Monster<PhantasmalGardener>());
