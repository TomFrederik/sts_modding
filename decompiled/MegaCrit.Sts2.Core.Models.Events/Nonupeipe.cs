...
public class Nonupeipe : AncientEventModel
{
	...
	public override IEnumerable<EventOption> AllPossibleOptions => OptionPool.Concat(new _003C_003Ez__ReadOnlySingleElementList<EventOption>(BeautifulBraceletEventOption));
