...
{
	public override IEnumerable<CharacterModel> AnyCharacterDialogueBlacklist => new _003C_003Ez__ReadOnlySingleElementList<CharacterModel>(ModelDb.Character<Defect>());
