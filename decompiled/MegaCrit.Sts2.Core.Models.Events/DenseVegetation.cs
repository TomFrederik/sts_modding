...
public sealed class DenseVegetation : EventModel
{
	...
	private async Task Rest()
	{
		...
		SetEventState(L10NLookup("DENSE_VEGETATION.pages.REST.description"), new _003C_003Ez__ReadOnlySingleElementList<EventOption>(new EventOption(this, Fight, "DENSE_VEGETATION.pages.REST.options.FIGHT")));
	}
