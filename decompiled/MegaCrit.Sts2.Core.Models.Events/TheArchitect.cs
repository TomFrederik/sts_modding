...
public sealed class TheArchitect : EventModel
{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		{
			return new _003C_003Ez__ReadOnlySingleElementList<EventOption>(CreateProceedOption());
		}
		CurrentLineIndex = 0;
		return new _003C_003Ez__ReadOnlySingleElementList<EventOption>(CreateOptionForCurrentLine());
	}
	...
	private async Task AdvanceDialogue()
	{
		...
		if (CurrentLineIndex < Dialogue.Lines.Count)
		{
			...
			eventOptions = new _003C_003Ez__ReadOnlySingleElementList<EventOption>(CreateOptionForCurrentLine());
		}
		else
		{
			eventOptions = new _003C_003Ez__ReadOnlySingleElementList<EventOption>(CreateProceedOption());
		}
	...
	private async Task PlayCurrentLine()
	{
		...
		if (CurrentLineIndex == 0)
		{
			SetEventState(_emptyLocString, new _003C_003Ez__ReadOnlySingleElementList<EventOption>(CreateOptionForCurrentLine()));
		}
	}
