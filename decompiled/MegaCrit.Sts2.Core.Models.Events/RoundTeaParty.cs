...
public sealed class RoundTeaParty : EventModel
{
	...
	{
		SetEventState(L10NLookup("ROUND_TEA_PARTY.pages.PICK_FIGHT.description"), new _003C_003Ez__ReadOnlySingleElementList<EventOption>(new EventOption(this, ContinueFight, "ROUND_TEA_PARTY.pages.PICK_FIGHT.options.CONTINUE_FIGHT").ThatWontSaveToChoiceHistory()));
