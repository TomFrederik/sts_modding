...
public sealed class WarHistorianRepy : EventModel
{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		{
			new EventOption(this, UnlockCage, "WAR_HISTORIAN_REPY.pages.INITIAL.options.UNLOCK_CAGE", HoverTipFactory.FromRelic<HistoryCourse>().Concat(new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromCard<LanternKey>()))),
