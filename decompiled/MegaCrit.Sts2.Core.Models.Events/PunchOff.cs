...
public sealed class PunchOff : EventModel
{
	...
	{
		_punchCts?.Cancel();
		SetEventState(L10NLookup("PUNCH_OFF.pages.I_CAN_TAKE_THEM.description"), new _003C_003Ez__ReadOnlySingleElementList<EventOption>(new EventOption(this, Fight, "PUNCH_OFF.pages.I_CAN_TAKE_THEM.options.FIGHT")));
		return Task.CompletedTask;
	}
