...
public sealed class InfestedAutomaton : EventModel
{
	...
	{
		CardCreationOptions options = CardCreationOptions.ForNonCombatWithDefaultOdds(new _003C_003Ez__ReadOnlySingleElementList<CardPoolModel>(base.Owner.Character.CardPool), (CardModel c) => c.Type == CardType.Power);
	...
	{
		CardCreationOptions options = CardCreationOptions.ForNonCombatWithDefaultOdds(new _003C_003Ez__ReadOnlySingleElementList<CardPoolModel>(base.Owner.Character.CardPool), delegate(CardModel c)
		{
