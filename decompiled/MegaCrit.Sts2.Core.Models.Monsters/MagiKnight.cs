...
public sealed class MagiKnight : MonsterModel
{
	...
	private async Task DampenMove(IReadOnlyList<Creature> targets)
	{
		...
		((Node)(object)NCombatRoom.Instance?.CombatVfxContainer).AddChildSafely((Node?)(object)NSpeechBubbleVfx.Create(_dampenDialogue.GetFormattedText(), base.Creature, 2.0));
