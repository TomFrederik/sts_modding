...
public sealed class BowlbugEgg : MonsterModel
{
	...
	public override void SetupSkins(NCreatureVisuals visuals)
	{
		...
		Node node = ((Node)visuals).GetNode(NodePath.op_Implicit("Visuals/CocoonSlotNode/Cocoon"));
		if (node != null)
		{
			MegaSprite megaSprite = new MegaSprite(Variant.op_Implicit((GodotObject)(object)node));
