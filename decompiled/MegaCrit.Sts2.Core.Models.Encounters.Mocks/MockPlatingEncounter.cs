...
public sealed class MockPlatingEncounter : EncounterModel
{
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters => new _003C_003Ez__ReadOnlySingleElementList<MonsterModel>(ModelDb.Monster<MockPlatingMonster>());
	...
	protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
	{
		...
		return new _003C_003Ez__ReadOnlySingleElementList<(MonsterModel, string)>((monsterModel, null));
	}
}
