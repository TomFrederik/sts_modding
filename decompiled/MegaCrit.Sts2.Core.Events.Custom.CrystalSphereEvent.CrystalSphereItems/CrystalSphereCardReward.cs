...
public class CrystalSphereCardReward : CrystalSphereItem
{
	...
	public override async Task RevealItem(Player owner)
	{
		...
		CardCreationOptions options = new CardCreationOptions(new _003C_003Ez__ReadOnlySingleElementList<CardPoolModel>(owner.Character.CardPool), CardCreationSource.Other, CardRarityOddsType.Uniform, (CardModel c) => c.Rarity == _rarity).WithRngOverride(_grid.Rng);
