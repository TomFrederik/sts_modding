...
public class NTopBarPortraitTip : TextureRect
{
	...
	{
		public static readonly StringName _showTip = StringName.op_Implicit("_showTip");
	}
	...
	{
		if ((ref name) == PropertyName._showTip)
		{
			_showTip = VariantUtils.ConvertTo<bool>(ref value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if ((ref name) == PropertyName._showTip)
		{
			value = VariantUtils.CreateFrom<bool>(ref _showTip);
			return true;
		}
	...
	internal static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		list.Add(new PropertyInfo((Type)1, PropertyName._showTip, (PropertyHint)0, "", (PropertyUsageFlags)4096, false));
		return list;
	}
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		info.AddProperty(PropertyName._showTip, Variant.From<bool>(ref _showTip));
	}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._showTip, ref val))
		{
			_showTip = ((Variant)(ref val)).As<bool>();
		}
	}
}
